...
function post_convert() {
    $('article:not(.field_loaded)').each(function() {
        ...
        var $cta_link = '';
        if ($('.field .cta_link', $article).length) {
            $cta_link = $('.field .cta_link', $article).text().replaceAll(' ', '').replaceAll(/(?:\r\n|\r|\n)/g, '');
        }
        // console.log('$cta_link = ' + $cta_link);

        var $cta_text = '';
        if ($('.field .cta_text', $article).length) {
            $cta_text = $('.field .cta_text', $article).html().replaceAll('  ', '').replace(/<br\s*\/?>/gi, '');
        }
        ...
        if ($(this).hasClass('is_post')) {
            ...
            if ($status == 'off') {
                ...
                $product = encodeURIComponent($('h1.title', this).text()).replaceAll('%0A', '');
                $html += '<div class="cta"><a class="link" href="' + ($cta_link ? $cta_link : 'https://api.whatsapp.com/send?phone=' + $_config['cta']['whatsapp'] + '&text=' + $_config['cta']['order_text'].replaceAll('[admin]', $admin).replaceAll('[product]', $product) + '%0A%0Avia. ' + $_config['url']['canonical']) + '" target="_popwin">' + ($cta_text ? $cta_text : '<i class="icon left"><svg viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg"><path d="M260.062 32C138.605 32 40.134 129.701 40.134 250.232c0 41.23 11.532 79.79 31.559 112.687L32 480l121.764-38.682c31.508 17.285 67.745 27.146 106.298 27.146C381.535 468.464 480 370.749 480 250.232 480 129.701 381.535 32 260.062 32zm109.362 301.11c-5.174 12.827-28.574 24.533-38.899 25.072-10.314.547-10.608 7.994-66.84-16.434-56.225-24.434-90.052-83.844-92.719-87.67-2.669-3.812-21.78-31.047-20.749-58.455 1.038-27.413 16.047-40.346 21.404-45.725 5.351-5.387 11.486-6.352 15.232-6.413 4.428-.072 7.296-.132 10.573-.011 3.274.124 8.192-.685 12.45 10.639 4.256 11.323 14.443 39.153 15.746 41.989 1.302 2.839 2.108 6.126.102 9.771-2.012 3.653-3.042 5.935-5.961 9.083-2.935 3.148-6.174 7.042-8.792 9.449-2.92 2.665-5.97 5.572-2.9 11.269 3.068 5.693 13.653 24.356 29.779 39.736 20.725 19.771 38.598 26.329 44.098 29.317 5.515 3.004 8.806 2.67 12.226-.929 3.404-3.599 14.639-15.746 18.596-21.169 3.955-5.438 7.661-4.373 12.742-2.329 5.078 2.052 32.157 16.556 37.673 19.551 5.51 2.989 9.193 4.529 10.51 6.9 1.317 2.38.901 13.531-4.271 26.359z"></path></svg></i> ' + $_config['cta']['order_button']) + '</a><a class="bagikan" target="pop-bagikan"><i class="icon"><svg viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg"><path d="M448 248L288 96v85.334C138.666 202.667 85.333 309.334 64 416c53.333-74.666 117.333-108.802 224-108.802v87.469L448 248z"/></svg></i></a></div>';
            }
        }
...
function shortcode() {
    $('.post-body, .comment').each(function() {
        $(this).html(
            $(this).html()
            .replace(/\[youtube\]/g, '<a data-shortcode="youtube" target="pop-video" href="').replace(/\[\/youtube\]/g, '"></a>')
    ...
    $('[data-shortcode]').each(function() {
        ...
        if ($shortcode == 'youtube') {
            ...
            $(this).attr('style', 'display:block;position:relative;');
            $(this).append('<img style="border-radius:10px;display:block;" data-src="https://img.youtube.com/vi/' + youtube_id + '/sddefault.jpg" alt="youtube"/>');
            $(this).append('<svg style="display:block;position:absolute;top:50%;left:50%;transform:translate(-50%,-50%);width:20%;height:auto;" xmlns="http://www.w3.org/2000/svg" height="800" width="1200" viewBox="-35.20005 -41.33325 305.0671 247.9995"><path d="M229.763 25.817c-2.699-10.162-10.65-18.165-20.748-20.881C190.716 0 117.333 0 117.333 0S43.951 0 25.651 4.936C15.553 7.652 7.6 15.655 4.903 25.817 0 44.236 0 82.667 0 82.667s0 38.429 4.903 56.85C7.6 149.68 15.553 157.681 25.65 160.4c18.3 4.934 91.682 4.934 91.682 4.934s73.383 0 91.682-4.934c10.098-2.718 18.049-10.72 20.748-20.882 4.904-18.421 4.904-56.85 4.904-56.85s0-38.431-4.904-56.85" fill="red"/><path d="M93.333 117.559l61.333-34.89-61.333-34.894z" fill="#fff"/></svg>');
        }
    });
}
...
function etc() {
    ...
    $('#main').css('min-height', 'calc(100vh - ' + Number($header_height + $footer_height + 40) + 'px)');
...
function license() {
    ...
    function notice_html($text) {
        var $html = '\
            ...
            <style>* { font-family: "Rubik", sans-serif; font-weight:400; box-sizing:border-box;margin:0;padding:0; text-decoration:none; color:#636363; } b { font-weight: 500; }</style>\
            <div id="notice_html" style="display:flex;background:#fafafa;min-height:100vh;text-align:center;">\
                <div style="margin:auto;width:480px;max-width:80%;background:white;padding:30px;border-radius:10px;border:1px solid #ddd;">\
                    ...
                    <h2><b style="color:#232323;">Peringatan</b> :</h2>\
                    <br>\
                    <p>' + $text + '</p>\
                    <br>\
        ...
        if (location.hostname.indexOf('localhost') != -1 || location.hostname.indexOf('.blogspot.com') != -1 || location.hostname.indexOf('.blogger.com') != -1) {
            ...
            if ($license_key === '') {
                ...
                if($license_get_domain == '' || $license_get_domain == undefined) { // ngasal
                    ...
                    } else if ($license_get_item != $license_item) {
...
/* ==== / Peringatan : Menghapus script lisensi diatas dapat mengakibatkan kerusakan / error pada template.. ==== */
